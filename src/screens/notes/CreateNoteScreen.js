    ...
    case 'text':
      return (
        <View style={[styles.popupBox, styles.textFormattingBox]}>
          ...
          {/* Linked the close button to close your active menu state cleanly */}
          <TouchableOpacity style={styles.textButton} onPress={() => handleIconPress(null)}><Ionicons name="close" size={20} color={theme.textSoft} /></TouchableOpacity>
        </View>
      );
  ...
  return (
    <Screen scroll={false}>
      ...
      <View style={styles.container}>
        ...
        {renderMenuPopup(activeMenu, theme, handleIconPress)}
