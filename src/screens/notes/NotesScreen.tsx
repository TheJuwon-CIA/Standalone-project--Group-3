  ...
  return (
    <Screen scroll={false}>
      <FlatList
        ...
        ListHeaderComponent={(
          <>
            <Header showMenu avatar onRightPress={() => router.push('/profile-settings' as any)} />
            <SearchInput />
            <View style={styles.sectionHeader}>
              <Text style={[styles.sectionTitle, { color: theme.text }]}>Recent Notes</Text>
              <TouchableOpacity activeOpacity={0.75} onPress={() => router.push('/recent-notes' as any)}>
        ...
        ListEmptyComponent={(
          <TouchableOpacity style={[styles.emptyCard, { borderColor: theme.border }]} onPress={() => router.push('/create-note' as any)}>
